...
?>
    ...
    if (isset($_POST['save'])) {
        ...
        <div class="alert alert-danger alert-dismissable">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            Data karyawan gagal disimpan, silahkan coba lagi.
        </div>
    <?php
        }
    }
...
<form action="" class="form-horizontal" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" name="nama" pattern="<?php $huruf ?>" class="form-control" value="<?php echo $row['nama'];?>" placeholder="Nama" required>
        </div>
    </div>
    <div class="form-group">
