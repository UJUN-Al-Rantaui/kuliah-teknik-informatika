...
procedure biodata;
  ...
  begin
    textcolor(14);
    for i:=1 to 45 do write('=');
    writeln;
    for i:=1 to 5 do
      begin
        write('*');
        for index:=1 to 43 do write(' ');
        writeln('*');
      end;
    for i:=1 to 45 do write('=');
    writeln;
...
begin
  ...
  i:= addr(pointer);
  writeln('Alamat memori yang di gunakan variabel pointer adalah : ',i^);
  i:= addr(angka);
  writeln('Alamat memori yang di gunakan variable nama adalah : ',i^);
  readln;
end.